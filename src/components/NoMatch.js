...
export default function NoMatch() {
  ...
  return (
    <div className='bg-white w-[100vw] z-[999] h-[90vh] py-[2pc] flex flex-col justify-center items-center'>
